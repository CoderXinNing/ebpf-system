...
var knownServices = []servicePattern{
	...
	{name: "Java", svcType: "运行时", keywords: []string{"java", "jsvc"}},
	{name: "Python", svcType: "运行时", keywords: []string{"python", "gunicorn", "uvicorn"}},
	{name: "Node.js", svcType: "运行时", keywords: []string{"node", "nodejs"}},
