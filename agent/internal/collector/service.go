...
var knownServices = []servicePattern{
	...
	{name: "Nginx", svcType: "Web应用", keywords: []string{"nginx"}},
	{name: "Apache", svcType: "Web应用", keywords: []string{"httpd", "apache2"}},
	{name: "Tomcat", svcType: "Web应用", keywords: []string{"tomcat", "catalina", "bootstrap.jar"}},
